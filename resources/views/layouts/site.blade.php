...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="{{ route('voyages.index') }}">RazoVoyages</a>
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          @auth
            <li class="nav-item"><a href="{{ route('home') }}" class="nav-link">Mon compte</a></li>
            <li class="nav-item">
          ...
          <li class="nav-item"><a href="{{ route('register') }}" class="nav-link">M'inscrire</a></li>
            <li class="nav-item"><a href="{{ route('login') }}" class="nav-link">Me connecter</a></li>
          @endauth
        </ul>
      </div>
    </div>
